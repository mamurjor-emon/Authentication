...
<body>
    ...
    <div class="body-wrapper" id="verify-user">
                            ...
                            <div
                                ...
                                <div class="mdc-card">
                                    <form method="POST" action="{{ route('login') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="mdc-layout-grid">
                                            <p class="verify-title">Please Cheak Your Email Account And Copy Verification Code....</p>
                                            <div class="mdc-layout-grid__inner">
                                                <div class="mdc-layout-grid__cell  mdc-layout-grid__cell--span-12">
                                                    <div class="mdc-text-field w-100">
                                                        <input class="mdc-text-field__input" type="number"
                                                            id="text-field-hero-input" name="verify_code">
                                                        <div class="mdc-line-ripple"></div>
                                                        <label for="text-field-hero-input"
                                                            class="mdc-floating-label">Enter You'r Verification Code
                                                ...
                                                <div
                                                    ...
                                                    <button class="mdc-button mdc-button--unelevated filled-button--secondary w-100"
                                                        type="button"><a class="text-white" href="{{ url('/') }}">Cancel</a></button>
                                                </div>
                                                <div
                                                    ...
                                                    <button class="mdc-button mdc-button--unelevated filled-button--success w-100"
