...
@section('add_button')
    <div>
        <a href="{{ route('admin.portfolio.categories.create') }}" class="create-btn btn btn-md mr-3 d-flex justify-content-between align-items-center text-white">
...
@section('content')
    <div class="row mt-3">
        ...
        <div class="card px-3 py-3">
            ...
            <table id="portfolioCategories" class="display" style="width:100%">
                <thead>
                    <tr>
                        <th>Sl</th>
                        <th>Name</th>
...
@push('scripts')
<script>
    var tables  = $('#portfolioCategories').DataTable({
        processing: true,
        serverSide: true,
        ...
        ajax: {
            url: "{{ route('admin.portfolio.categories.get.data') }}",
            type: "POST",
            dataType: "JSON",
            data: function(d) {
                d._token = _token,
        ...
        buttons: {
            buttons: [{
                ...
                },
                {
                    ...
                    filename: 'portfolio_categories_{{ date('d-m-Y') }}',
