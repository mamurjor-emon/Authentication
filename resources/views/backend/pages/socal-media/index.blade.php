...
@section('add_button')
    <div>
        <a href="{{ route('admin.socal.media.create') }}" class="create-btn btn btn-md mr-3 d-flex justify-content-between align-items-center text-white">
...
@section('content')
    <div class="row mt-3">
        ...
        <div class="card px-3 py-3">
            ...
            <table id="socalMedias" class="display" style="width:100%">
                <thead>
                    <tr>
                        <th>Sl</th>
                        <th>Icon</th>
...
@push('scripts')
<script>
    var tables  = $('#socalMedias').DataTable({
        processing: true,
        serverSide: true,
        ...
        ajax: {
            url: "{{ route('admin.socal.media.get.data') }}",
            type: "POST",
            dataType: "JSON",
            data: function(d) {
                d._token = _token,
        ...
        buttons: {
            buttons: [{
                ...
                },
                {
                    extend: 'pdf',
                    title: 'Socal Media',
                    filename: 'socal_media_{{ date('d-m-Y') }}',
