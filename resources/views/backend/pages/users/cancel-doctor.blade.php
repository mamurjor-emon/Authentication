...
@section('content')
    <div class="row mt-3">
        ...
        <div class="card px-3 py-3">
            ...
            <table id="allCancelDoctors" class="display" style="width:100%">
                <thead>
                    <tr>
                        <th>Sl</th>
                        <th>First Name</th>
...
@push('scripts')
<script>
    var tables  = $('#allCancelDoctors').DataTable({
        processing: true,
        serverSide: true,
        ...
        ajax: {
            url: "{{ route('admin.user.management.cancel.doctors.get.data') }}",
            type: "POST",
            dataType: "JSON",
            data: function(d) {
                d._token = _token,
        ...
        buttons: {
            buttons: [{
                ...
                {
                    extend: 'pdf',
                    title: 'Cancel Doctors',
                    filename: 'cancel_doctors_{{ date('d-m-Y') }}',
