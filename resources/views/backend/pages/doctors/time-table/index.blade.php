...
@section('add_button')
    <div>
        <a href="{{ route('admin.doctor.time-table.create') }}" class="create-btn btn btn-md mr-3 d-flex justify-content-between align-items-center text-white">
...
@section('content')
    <div class="row mt-3">
        ...
        <div class="card px-3 py-3">
            ...
            <table id="slots" class="display" style="width:100%">
                <thead>
                    <tr>
                        <th>Sl</th>
                        <th>Time</th>
...
<script>
    var tables  = $('#slots').DataTable({
        ...
        ajax: {
            url: "{{ route('admin.doctor.time-table.get.data') }}",
            type: "POST",
            dataType: "JSON",
            data: function(d) {
                d._token = _token,
