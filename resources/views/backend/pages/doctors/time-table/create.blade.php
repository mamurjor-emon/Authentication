                    ...
                    <form method="POST" action="{{ route('admin.doctor.time-table.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-5 mt-2">
                            <x-form.textbox labelName="Time" parantClass="col-12 col-md-6" name="time"
                                type="time" required="required" placeholder="Enter Time..!" errorName="time"
                                class="py-2" value="{{ old('time') }}"></x-form.textbox>
                                ...
                                value="{{ $totalTimes ? $totalTimes->count() + 1 : old('order_by') }}"></x-form.textbox>
                        </div>
                        <div class="row g-5 mt-2">
