...
@section('add_button')
    <div>
        <a href="{{ route('admin.doctor.day.create') }}" class="create-btn btn btn-md mr-3 d-flex justify-content-between align-items-center text-white">
...
@section('content')
    <div class="row mt-3">
        ...
        <div class="card px-3 py-3">
            ...
            <table id="days" class="display" style="width:100%">
                <thead>
                    <tr>
                        <th>Sl</th>
                        <th>Name</th>
...
<script>
    var tables  = $('#days').DataTable({
        ...
        ajax: {
            url: "{{ route('admin.doctor.day.get.data') }}",
            type: "POST",
            dataType: "JSON",
            data: function(d) {
                d._token = _token,
