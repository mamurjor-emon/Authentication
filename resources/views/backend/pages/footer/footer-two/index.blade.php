...
@section('add_button')
    <div>
        <a href="{{ route('admin.footer.two.create') }}" class="create-btn btn btn-md mr-3 d-flex justify-content-between align-items-center text-white">
...
@section('content')
    <div class="row mt-3">
        ...
        <div class="card px-3 py-3">
            ...
            <table id="footerTwo" class="display" style="width:100%">
                <thead>
                    <tr>
                        <th>Sl</th>
                        <th>Name</th>
...
@push('scripts')
<script>
    var tables  = $('#footerTwo').DataTable({
        processing: true,
        serverSide: true,
        ...
        ajax: {
            url: "{{ route('admin.footer.two.get.data') }}",
            type: "POST",
            dataType: "JSON",
            data: function(d) {
                d._token = _token,
        ...
        buttons: {
            buttons: [{
                ...
                {
                    extend: 'pdf',
                    title: 'Footer Two Menu',
                    filename: 'footer_two_menu_{{ date('d-m-Y') }}',
