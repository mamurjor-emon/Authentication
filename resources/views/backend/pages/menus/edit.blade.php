            ...
            <div class="card px-3 py-3">
                ...
                <div class="menu-create-form">
                    <form method="POST" action="{{ route('admin.menu.update') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="update_id" value="{{ $editMenu->id }}">
                        <div class="row g-5">
                            <x-form.textbox labelName="Name" parantClass="col-12 col-md-6" name="name"
                                ...
                                value="{{ $editMenu->name ?? '' }}"></x-form.textbox>
                            ...
                            <x-form.textbox labelName="Slug" parantClass="col-12 col-md-6" name="slug"
                                ...
                                value="{{ $editMenu->slug ?? '' }}"></x-form.textbox>
                        </div>
                        <div class="row g-5 mt-2">
                            <x-form.textbox labelName="Url" parantClass="col-12 col-md-6" name="url" required="required"
                                ...
                                value="{{ $editMenu->url ?? '' }}"></x-form.textbox>
                            ...
                            <x-form.selectbox parantClass="col-12 col-md-6" class="form-control py-2" name="target"
                                ...
                                <option value="0" {{ $editMenu->target == 0 ? 'selected' : '' }}>Same Page</option>
                                <option value="1" {{ $editMenu->target == 1 ? 'selected' : '' }}>New Page</option>
                            </x-form.selectbox>
                        </div>
                        <div class="row g-5 mt-2">
                            <x-form.selectbox parantClass="col-12 col-md-6" class="form-control py-2" name="parent_id"
                                ...
                                @forelse ($parentMenu as $menu)
                                    <option value="{{ $menu->id }}"
                                        {{ $editMenu->parent_id == $menu->id ? 'selected' : '' }}>{{ $menu->name }}
                                    </option>
                                @empty
                                @endforelse
                            </x-form.selectbox>
                        ...
                        <div class="row g-5 mt-2">
                            <x-form.textbox labelName="Order By" parantClass="col-12 col-md-6" name="order_by"
                                ...
                                value="{{ $editMenu->order_by }}"></x-form.textbox>
                            ...
                            <x-form.selectbox parantClass="col-12 col-md-6" class="form-control py-2" name="status"
                                ...
                                <option value="0" {{ $editMenu->status == '0' ? 'selected' : '' }}>Pending</option>
                                <option value="1" {{ $editMenu->status == '1' ? 'selected' : '' }}>Publish</option>
                            </x-form.selectbox>
