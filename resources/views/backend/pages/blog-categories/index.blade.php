...
@section('add_button')
    <div>
        <a href="{{ route('admin.blog.categories.create') }}" class="create-btn btn btn-md mr-3 d-flex justify-content-between align-items-center text-white">
            ...
            <div class="bg-white border-bottom-0 pb-4 d-flex justify-content-between align-items-center flex-row">
                ...
                <div class="email-template-search-bar btn-group d-flex align-items-center">
                    <input type="text" id="datatable-search" class="h-100 border"
                        placeholder="Categorie Name, Order By ....">
                    <button type="button"
                        class="mdc-button mdc-button--raised filled-button--info mdc-ripple-upgraded"><i
                            class="mdi mdi-magnify"></i></button>
                </div>
            </div>
            <table id="blog_categories" class="display" style="width:100%">
                <thead>
                    <tr>
                        <th>Sl</th>
...
@push('scripts')
<script>
    var tables  = $('#blog_categories').DataTable({
        processing: true,
        serverSide: true,
        ...
        ajax: {
            url: "{{ route('admin.blog.categories.get.data') }}",
            type: "POST",
            dataType: "JSON",
            data: function(d) {
                d._token = _token,
        ...
        buttons: {
            buttons: [{
                ...
                },
                {
                    ...
                    filename: 'blog_categories_{{ date('d-m-Y') }}',
