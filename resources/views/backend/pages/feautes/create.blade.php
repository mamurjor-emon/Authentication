        ...
        <div class="col-md-12">
            <div class="card px-3 py-3">
                ...
                <div class="menu-create-form">
                    <form method="POST" action="{{ route('admin.feautes.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row g-5">
                        ...
                        <div class="row g-5 mt-2">
                            ...
                            <x-form.textbox labelName="Order By" parantClass="col-12 col-md-6" name="order_by"
                                ...
                                value="{{ $totalFeautes->count() > 0 ? $totalFeautes->count() + 1 : 1 }}"></x-form.textbox>
                        </div>
                        <div class="row g-5 mt-2">
                            <x-form.textarea labelName="Discrption" parantClass="col-md-12" name="discrption"
                                required="required" errorName="discrption" value="{{ old('discrption') }}"></x-form.textarea>
                        </div>
