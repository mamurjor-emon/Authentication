...
@section('add_button')
    <div>
        <a href="{{ route('admin.blog.tags.create') }}" class="create-btn btn btn-md mr-3 d-flex justify-content-between align-items-center text-white">
...
@push('scripts')
<script>
    var tables  = $('#blog_tags').DataTable({
        processing: true,
        serverSide: true,
