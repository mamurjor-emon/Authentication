...
@section('add_button')
    <div>
        <a href="{{ route('admin.pricing.create') }}" class="create-btn btn btn-md mr-3 d-flex justify-content-between align-items-center text-white">
...
<script>
    var tables  = $('#pricing').DataTable({
        ...
        ajax: {
            url: "{{ route('admin.pricing.get.data') }}",
            type: "POST",
            dataType: "JSON",
            data: function(d) {
                d._token = _token,
